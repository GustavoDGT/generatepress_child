...
<div id="wip-modal-suscription" class="overlay_modal">
  ...
  <div class="modal_cm grid-100 mobile-grid-100 grid-parent wip-40 align-center bg-section" style="background-image: url( '<?php echo $upload_path . '/2018/09/bg_suscription.png'; ?>' )">
