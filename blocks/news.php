	        ...
	        <div class="wrapper-box-icon has_custom_image text-center image_box">
	          <div class="smicon-box iconbox-top">
	            <div class="boxes-icon">
	              <img src="<?php echo $img_url; ?>" title="<?php echo $item->get_title(); ?>" alt="<?php echo $item->get_title(); ?>">
	            </div>
	            <div class="content-inner">
	              <div class="sc-heading article_heading">
	                <h4><a href="<?php echo $item->get_link(); ?>" title="<?php echo $item->get_title(); ?>"><?php echo $item->get_title(); ?></a></h4>
	                <span class="date-publish"><?php echo $item->get_date( 'M' ).' '.$item->get_date( 'd' ).', '.$item->get_date( 'Y' ); ?></span>
