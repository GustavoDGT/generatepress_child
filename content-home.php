...
<section id="wip-contact" class="grid-100 wip-40-top wip-20-bottom align-center bg-section skinny-section" style="background-image: url('<?php echo get_stylesheet_directory_uri() . '/images/bg-contact.jpg'; ?>')">
  <div class="grid-100 mobile-grid-100">
